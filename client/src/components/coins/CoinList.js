        ...
        return this.props.coinList.map(coin => {
            return (
                <tr key={coin.id}>
                    ...
                    <td className="center-align" style={_.includes(coin.percent_change_1h, '-') ? {color: '#ef0404'} : {color: '#56db0f'}}>{coin.percent_change_1h}%</td>
                    <td className="center-align" style={_.includes(coin.percent_change_24h, '-') ? {color: '#ef0404'} : {color: '#56db0f'}}>{coin.percent_change_24h}%</td>
                    <td className="center-align" style={_.includes(coin.percent_change_7d, '-') ? {color: '#ef0404'} : {color: '#56db0f'}}>{coin.percent_change_7d}%</td>
